...
export default function create() {
    ...
    const tileset = map.addTilesetImage('rocks', 'tiles')
    map.createLayer('Platform', tileset)



    map.getObjectLayer('rock').objects.forEach((rock) => {
        this.rocks.create(rock.x, rock.y, 'rock1');
    });
    ...
    if (this.player.playerObject.active == true && values.currentLevel == 2) {
